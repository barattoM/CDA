...
CREATE TABLE `affectationsuser` (
  ...
  KEY `FK_AffectionsUser_Services` (`IdService`),
  KEY `FK_AffectionsUser_Users` (`IdUser`),
  CONSTRAINT `FK_AffectionsUser_Services` FOREIGN KEY (`IdService`) REFERENCES `services` (`IdService`),
  CONSTRAINT `FK_AffectionsUser_Users` FOREIGN KEY (`IdUser`) REFERENCES `users` (`IdUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `fichiersreunion`
--

DROP TABLE IF EXISTS `fichiersreunion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `fichiersreunion`
--

LOCK TABLES `fichiersreunion` WRITE;
/*!40000 ALTER TABLE `fichiersreunion` DISABLE KEYS */;
/*!40000 ALTER TABLE `fichiersreunion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `participations` (
  ...
  KEY `FK_Participation_RolesReunion` (`IdRoleReunion`),
  CONSTRAINT `FK_Participation_Reunions` FOREIGN KEY (`IdReunion`) REFERENCES `reunions` (`IdReunion`),
  CONSTRAINT `FK_Participation_RolesReunion` FOREIGN KEY (`IdRoleReunion`) REFERENCES `rolesreunion` (`IdRoleReunion`),
...
INSERT INTO `rolesapp` VALUES (1,'Admin');
/*!40000 ALTER TABLE `rolesapp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rolesreunion`
--

DROP TABLE IF EXISTS `rolesreunion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `rolesreunion`
--

LOCK TABLES `rolesreunion` WRITE;
/*!40000 ALTER TABLE `rolesreunion` DISABLE KEYS */;
/*!40000 ALTER TABLE `rolesreunion` ENABLE KEYS */;
UNLOCK TABLES;
