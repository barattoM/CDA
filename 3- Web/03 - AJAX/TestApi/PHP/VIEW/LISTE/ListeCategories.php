...
echo '<div class="caseListe grid-columns-span-5">Liste des Categories </div>';
...
echo '<div class="caseListe">IdTypeProduit</div>';
...
echo '<div class="caseListe">'.$unObjet->getIdTypeProduit().'</div>';
