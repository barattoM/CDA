...
echo '<label for=LibelleCategorie class="caseForm">'.texte("LibelleCategorie").'</label>';
echo '<div class="caseForm"><input type="text" '.$disabled .'value="'.$elm->getLibelleCategorie().'" name=LibelleCategorie pattern="'.$regex["*"].'"></div>';
echo '<div class="caseForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm"><i class="fas fa-check-circle"></i></div>';

echo '<label for=IdTypeProduit class="caseForm">'.texte("IdTypeProduit").'</label>';
echo '<div class="caseForm"><input type="text" '.$disabled .'value="'.$elm->getIdTypeProduit().'" name=IdTypeProduit pattern="'.$regex["*"].'"></div>';
echo '<div class="caseForm"><i class="fas fa-question-circle"></i></div>';
echo '<div class="caseForm"><i class="fas fa-check-circle"></i></div>';
